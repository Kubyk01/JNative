...
int32_t __jnative_fn_jdk_internal_misc_Unsafe_compareAndExchangeInt__Ljava_lang_Object_JII_I(
        void* obj, int64_t offset, int32_t expected, int32_t x)
{
    void* addr = effective_address(obj, offset);
    int32_t witness = expected;
    __atomic_compare_exchange_n((int32_t*)addr, &witness, x, 0,
                                __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return witness;
}

int64_t __jnative_fn_jdk_internal_misc_Unsafe_compareAndExchangeLong__Ljava_lang_Object_JJJ_J(
        void* obj, int64_t offset, int64_t expected, int64_t x)
{
    void* addr = effective_address(obj, offset);
    int64_t witness = expected;
    __atomic_compare_exchange_n((int64_t*)addr, &witness, x, 0,
                                __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return witness;
}

void* __jnative_fn_jdk_internal_misc_Unsafe_compareAndExchangeReference__Ljava_lang_Object_JLjava_lang_Object_Ljava_lang_Object__Ljava_lang_Object_(
        void* obj, int64_t offset, void* expected, void* x)
{
    void* addr = effective_address(obj, offset);
    void* witness = expected;
    __atomic_compare_exchange_n((void**)addr, &witness, x, 0,
                                __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return witness;
}

// Byte/short/char/boolean/float/double variants — for completeness
int8_t __jnative_fn_jdk_internal_misc_Unsafe_compareAndExchangeByte__Ljava_lang_Object_JBB_B(
        void* obj, int64_t offset, int8_t expected, int8_t x)
{
    void* addr = effective_address(obj, offset);
    int8_t witness = expected;
    __atomic_compare_exchange_n((int8_t*)addr, &witness, x, 0,
                                __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return witness;
}
int16_t __jnative_fn_jdk_internal_misc_Unsafe_compareAndExchangeShort__Ljava_lang_Object_JSS_S(
        void* obj, int64_t offset, int16_t expected, int16_t x)
{
    void* addr = effective_address(obj, offset);
    int16_t witness = expected;
    __atomic_compare_exchange_n((int16_t*)addr, &witness, x, 0,
                                __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return witness;
}
uint16_t __jnative_fn_jdk_internal_misc_Unsafe_compareAndExchangeChar__Ljava_lang_Object_JCC_C(
        void* obj, int64_t offset, uint16_t expected, uint16_t x)
{
    void* addr = effective_address(obj, offset);
    uint16_t witness = expected;
    __atomic_compare_exchange_n((uint16_t*)addr, &witness, x, 0,
                                __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);
    return witness;
}